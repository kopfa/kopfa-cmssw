// -*- C++ -*-
//
// Package:    CMGElectronProducer
// Class:      CMGElectronProducer
//
/**\class CMGElectronProducer CMGElectronProducer.cc UserCode/CMGElectronProducer/src/CMGElectronProducer.cc
...
// $Id: CMGElectronProducer.cc,v 1.6 2013/02/07 21:28:11 tjkim Exp $
//
//
...
class CMGElectronProducer : public edm::EDFilter {
   public:
      explicit CMGElectronProducer(const edm::ParameterSet&);
      ~CMGElectronProducer();
...
//
CMGElectronProducer::CMGElectronProducer(const edm::ParameterSet& cfg)
{
...
CMGElectronProducer::~CMGElectronProducer()
{
...
bool
CMGElectronProducer::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  for (unsigned int i=0; i < electrons_->size();++i){
    ...
    double AEff03 = ElectronEffectiveArea::GetElectronEffectiveArea(ElectronEffectiveArea::kEleGammaAndNeutralHadronIso03, sceta, ElectronEffectiveArea::kEleEAData2012);

    //double relIso03 = (chIso03+nhIso03+phIso03-0.5*puChIso03)/electron.pt();
    double relIso03 = (chIso03+nhIso03+phIso03-AEff03*rhoIso)/electron.pt();
...
void
CMGElectronProducer::endJob() {
}

//define this as a plug-in
DEFINE_FWK_MODULE(CMGElectronProducer);
