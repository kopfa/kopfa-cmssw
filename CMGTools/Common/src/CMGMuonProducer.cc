// -*- C++ -*-
//
// Package:    CMGMuonProducer
// Class:      CMGMuonProducer
//
/**\class CMGMuonProducer CMGMuonProducer.cc UserCode/CMGMuonProducer/src/CMGMuonProducer.cc
...
// $Id: CMGMuonProducer.cc,v 1.4 2013/03/10 21:39:18 tjkim Exp $
//
//
...
class CMGMuonProducer : public edm::EDFilter {
   public:
      explicit CMGMuonProducer(const edm::ParameterSet&);
      ~CMGMuonProducer();
...
//
CMGMuonProducer::CMGMuonProducer(const edm::ParameterSet& cfg)
{
...
CMGMuonProducer::~CMGMuonProducer()
{
...
bool
CMGMuonProducer::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void
CMGMuonProducer::endJob() {
}

//define this as a plug-in
DEFINE_FWK_MODULE(CMGMuonProducer);
