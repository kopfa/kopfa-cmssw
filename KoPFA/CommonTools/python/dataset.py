...
from KoPFA.CommonTools.castorBaseDir import castorBaseDir
...
class Dataset( BaseDataset ):
    ...
    def buildListOfBadFiles(self):
        ...
        file_mask = castortools.matchingFiles(self.castorDir, '^%s_.*\.txt$' % mask)
        #removed followings since it is not relevant anymore
        #if file_mask:
        #    from KoPFA.CommonTools.edmIntegrityCheck import PublishToFileSystem
