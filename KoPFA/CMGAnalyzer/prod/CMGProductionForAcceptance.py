...
from PATCMG_acceptance_cfg import *

def processSample( sample, dir, geninfo):
  
    name = sample.split("/")
    eosdir = "/eos/cms/store/caf/user/tjkim/ttbb/genlevel"
    ...
    out.close()
    os.system("cmsBatch0.py 5 "+log+'/PATCMG_'+name[1]+'_cfg.py'+" -o "+log+"/Log"+" -r "+output+" -b 'bsub -G u_zh -q 2nd < batchScript.sh'")
